    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
              <h3 class="panel-title">แก้ไขบันทึกการโทร</h3>
            </div>
            <div class="panel-body">
                  ...
                  <form class="form-horizontal" role="form" method="POST" action="{{ url('/update_call_report') }}">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6">
                        <input type="text" class="form-control" name="customer_id" value="{{ Manage_callreport::getdata($id,'form','customer_id') }}">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6">
                        <input type="text" class="form-control" name="hashtag" value="{{ Manage_callreport::getdata($id,'form','hashtag') }}">
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6">
                        <textarea class="form-control" rows="5" name="comment" >{{ Manage_callreport::getdata($id,'form','comment') }}</textarea>
                      </div>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6">
                        <input type="text" class="form-control" name="assigned_id" value="{{ Manage_callreport::getdata($id,'form','assigned_id') }}">
                      </div>
                    </div>

                    <div class="form-group">
                      <div class="col-md-6 col-md-offset-4">
                        <button type="submit" class="btn btn-primary" name="submit" value="edit_call">
                          บันทึก
                        </button>
